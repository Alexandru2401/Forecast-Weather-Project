// Declaram functia care imi fa afisa vremea curenta - apelul ei se face in index.js
function displayCurrentWeather(cityName) {
    // Ne luam link-ul catre care trb sa facem request-ul;
    ...
    fetch(currentWeatherEndpoint)
        ...
        .then((data) => {
            // console.log(data);
            // Extragem prop de care avem nev din raspuns 
            const {name, dt, main, weather, wind} = data;
            // O sa luam ziua din sap - pt asta ne folosim de proprietatea dt - ca sa facem asta o sa ne creem un util de date 
            const day = getDayOfTheWeek(dt);
            //  O sa luam ora tot din prop dt 
